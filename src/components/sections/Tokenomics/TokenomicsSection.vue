	...
	>
		...
		>
			...
			>
				...
				<div
					class="flex flex-col gap-2 items-end absolute top-[-20px] left-[-40%] max-sm:top-[-120px] max-sm:left-[-10%]"
				>
					<div
						class="text-[32px] font-ibm-sans text-white leading-[150%] font-normal"
				...
				<div
					class="flex flex-col gap-2 items-end absolute bottom-[-20px] left-[-40%] max-sm:bottom-[-120px] max-sm:left-[-5%]"
				>
					<div
						class="text-[32px] font-ibm-sans text-white leading-[150%] font-normal"
		...
		<div class="pb-[100px] max-md:pb-[80px]">
			<div
				...
				style="
					...
					background: linear-gradient(0deg, #140b01 0%, #140b01 100%),
						radial-gradient(
							109.71% 96.25% at 100.13% 115.87%,
							#fff 0%,
							rgba(1, 13, 8, 0.01) 100%
						);
					box-shadow: 0px 0px 14px 0px rgba(88, 54, 18, 0.3) inset,
