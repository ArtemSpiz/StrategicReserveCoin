...
import DesktopCards from "@/assets/img/WhitepaperImgs/DesktopCards7.png";
</script>
...
<template>
  ...
  >
    <div class="flex gap-5 items-start w-full lg:flex-col">
      ...
      >
        <div class="mb-2">
          ...
          balance participation, accountability, and long-term stewardship.
        </div>
    ...
    <div class="max-w-[600px] lg:hidden h-auto">
      <img :src="Cards" />
    </div>
