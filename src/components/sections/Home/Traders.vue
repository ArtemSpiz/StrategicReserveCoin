    ...
    >
      ...
      >
        <div class="flex items-center flex-col gap-4">
          ...
          >
            Most coins are built to pump, <span>SRCoin is built to last.</span>
          </div>
          <div
          ...
          >
            Here’s the truth about 99% of memecoins: they have no reserve, no
            governance, no plan past next week’s listing. Founders dump.
            Communities scatter. And the token? It joins the graveyard.
          </div>
        </div>
        <RouterLink
          to="/whitepaper"
